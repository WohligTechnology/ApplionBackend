...
appAppliance.controller('MyCtrl', function ($scope, $http, $timeout, $upload) {
...
appAppliance.controller('editappliance',
    function ($scope, applianceRest, $location, $routeParams, $timeout, $upload) {
        ...
        $scope.onFileSelect = function ($files, callback, index) {
...
//                $scope.appliance.warranty[i].expiry = new Date($scope.appliance.warranty[i].expiry);
//                $scope.appliance.warranty[i].purchasedate = new Date($scope.appliance.warranty[i].purchasedate);
//            }
        ...
        $scope.update = function (data) {
            for (var i = 0; i < uploadres.length; i++) {
                $scope.appliance.billimage.push(uploadres[i]);
            }
